...
namespace ListMEAPI.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public Usuario AdicionarUsuario(Usuario Usuarios)
        {
            try
            {
                _listMEContext.Usuario.Add(Usuarios);
                _listMEContext.SaveChanges();
        ...
        public Residencias AdicionarResidencia(Residencias residencia)
        {
            try
            {
        ...
        [HttpPost("RelacionarUsuarioResidencia")]

        public ActionResult<UsuarioRelacaorResidencia> RelacionarUsuarioResidencia(UsuarioRelacaorResidencia Relacao, int IdUsuario, int IdResidencia)
        {
            var usuario = _listMEContext.Usuario.Find(IdUsuario);
            var residencia = _listMEContext.Residencias.Find(IdResidencia);

            Relacao.usuarioRelacaoResidencia = usuario;
            Relacao.residenciaRelacaoResidencia = residencia;
            _listMEContext.RelacaoUsuarioResidencia.Add(Relacao);
        ...
        public ActionResult<UsuarioRelacaorResidencia> RequererRelacaoUsuarioResidencia()
        {
            return Ok(_listMEContext.RelacaoUsuarioResidencia.Include(c => c.residenciaRelacaoResidencia).Include(c => c.usuarioRelacaoResidencia).ToList());
        }
    }
}
